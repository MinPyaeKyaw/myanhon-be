...
describe('middlewares', () => {
  ...
  it('GET / types / invalid token', async () => {
    await Request(app)
      ...
      .set(
        'Authorization',
        'bearer ' +
          'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InVzZXJlbWFpbEBleGFtcGxlLmNvbSIsImNvZGUiOiJCRjVDVkwiLCJyZXNldFBhc3N3b3JkVG9rZW4iOnRydWUsImlhdCI6MTY4MjE4Njk3M30.32L6hNHnjmTS06-kqG_51qtbtikjOC9zankN9rI4WhI',
      )
      .expect(401)
      .then(response => {
        expect(response.body).toEqual({
  ...
  it('PATCH / edit user / unauthorized access', async () => {
    await Request(app)
      .patch(
        process.env.API_PREFIX + '/user/f242dc2d-1328-420d-b0c6-3ad2458f1c15',
      )
      .send({

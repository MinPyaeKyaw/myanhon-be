...
describe('auth', () => {
    ...
    it('POST / user / reset password', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(__1.default)
            ...
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InVzZXJlbWFpbEBleGFtcGxlLmNvbSIsImNvZGUiOiJMMVVZNlciLCJyZXNldFBhc3N3b3JkVG9rZW4iOnRydWUsImlhdCI6MTY4MjE0NjEwOX0.Sa2lvJ4wfBnLuXSYYXFWWQWnuQOLAfI3Klh98HaiRQw')
            .send({
            newPassword: '4321',
            email: 'useremailUTLMPX@example.com',
        })

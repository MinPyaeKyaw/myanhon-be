...
describe('User', () => {
  ...
  it('PATCH / edit user / user not found', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      return (0, supertest_1.default)(__1.default)
        .patch(
          process.env.API_PREFIX + '/user/f242dc2d-1328-420d-b0c6-3ad2458f1hj5',
        )
        .set(
          'Authorization',
          'bearer ' +
  ...
  it('POST / user tracking / upsert', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      return (0, supertest_1.default)(__1.default)
        .post(
          process.env.API_PREFIX + '/user/d0f29116-a4bd-4d8b-9259-6e79ff6c5e9c',
        )
        .send({

...
examRouter.post("/exam-submit", apiKeyMiddleware_1.apiKeyMiddleware, examController_1.submitExam);
examRouter.get("/exam", apiKeyMiddleware_1.apiKeyMiddleware, queryValidators_1.examQueryValidation, examController_1.getExam);

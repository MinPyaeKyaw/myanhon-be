...
exports.test = exports.changeUserPhonePolicy = void 0;
const functions_1 = require("../../utils/functions");
const changeUserPhonePolicy = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.changeUserPhonePolicy = changeUserPhonePolicy;
const test = (id, ie) => {
    console.log(id, ie);
};
exports.test = test;

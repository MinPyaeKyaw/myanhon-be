...
exports.suggestFormSubmitMiddleware = void 0;
const client_1 = require("@prisma/client");
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const functions_1 = require("../utils/functions");
const prisma = new client_1.PrismaClient();
const suggestFormSubmitMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.suggestFormSubmitMiddleware = suggestFormSubmitMiddleware;
